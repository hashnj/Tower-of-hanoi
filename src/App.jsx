...
function Game(){
  ...
  return(
    ...
    <div className='outr'>
      ...
      <div className="absolute shadow-lg shadow-gray-500/40 top-[20vh] text-xl p-3">Minimum-step Solution with {discs} Discs has {mini} steps </div>
      <div className="absolute shadow-lg shadow-gray-500/40 bottom-[20vh] text-xl p-3">Number of moves: {score} </div>
      {btn &&
